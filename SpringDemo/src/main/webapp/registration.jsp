...
<div class="main">
                ...
                <div class="signup-form">
                    ...
                    <form method="POST" action="/register" class="register-form" id="register-form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" placeholder="Emp Name" pattern="[A-Za-z]{2,20}"
                             required="required" />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" id="email" placeholder="Your Email" pattern="[a-zA-Z0-9+_.-]+@[a-zA-Z0-9.-]+[com]$"
                             required="required" />
                        </div>
                      
                        <div class="form-group">
                            <label for="contact"><i class="zmdi zmdi-phone"></i></label>
                            <input type="text" name="contact" id="contact" placeholder="Contact no" pattern="[0-9]{10}"  required="required" />
                        </div>
  ...
  <div class="form-group">
                            ...
                            <input type="password" name="pass" id="pass" placeholder="Password"    pattern="^(?=.*[A-Z])(?=.*[0-9])(?=.*[@#$%^&+=!])(?=.{7,}).*$" required="required" />
                        </div>
                        <div class="form-group">
...
<button type="button" class="custom-button" onclick="window.location.href='/loginn'">I am already a member</button>
