...
<body>
   <form action="UpdateAndDelete" method="post">
    ...
    <div class="form-group">
        ...
        <input type="text" name="role" id="role" value="<%= request.getParameter("role") %>" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="contact" id="contact" value="<%= request.getParameter("contact") %>" required>
    </div>
    <div class="form-group">
